...
namespace MrKupido.Web.Controllers
{
    public class ImportController : BaseController
    {
        ...
        [HttpPost]
        public IActionResult LoadImportedRecipes(string langISO)
        {
        ...
        public ActionResult MakeDirectionsBasic(string langISO, string directions)
        {
            ...
            directions = System.Net.WebUtility.HtmlDecode(directions);
